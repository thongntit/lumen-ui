...
export type { LogoCloudProps } from "./components/LogoCloud";
...
export type { PricingProps, PricingTier } from "./components/Pricing";
...
export type { NewsletterProps } from "./components/Newsletter";
